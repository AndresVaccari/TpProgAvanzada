...
<body>
	...
	<main>
		<form action="ServletBandejaSalida" method="get">
				...
				<div class="d-flex col-8 p-5 bg-light border rounded-4">
					<ul class="list-group w-100 border border-dark overflow-hidden">
						...
						if (mensajes.length != 0) {
							%>
							<div class="row">
								<div class="col-2 border-end border-dark"><b>Destinatario</b> </div>
							...
							for (Mensaje mensaje : mensajes) {
								...
								<li class="row bg-white">
									<div class="col-2 border-end border-dark"> <%=mensaje.getDestinatario()%></div>
